...
/**
 * Preload for the OVERLAY renderer. Exposes a minimal, channel-whitelisted
 * bridge as window.saysomething = { send, on, invoke }.
 *
 * The channel lists below mirror the OVERLAY subset in src/main/ipc.js. They are
...
const SEND = ['audio:chunk', 'audio:started', 'audio:stopped', 'audio:error', 'audio:silence'];
const ON = ['overlay:state', 'overlay:partial', 'audio:start', 'audio:stop', 'audio:abort', 'audio:vad'];
const INVOKE = [];
